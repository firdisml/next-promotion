          ...
          <nav className="py-3 relative flex items-center justify-between border-t border-gray-300 dark:border-gray-700 mt-4">
            ...
            <div className="flex-1 flex justify-between sm:justify-end">
              <button
                ...
                className="relative inline-flex disabled:line-through disabled:bg-gray-300 font-semibold focus:ring focus:ring-indigo-600 items-center px-4 py-2 border border-gray-300 text-sm rounded-md text-gray-700 bg-white hover:bg-gray-50"
              >
              ...
              <button
                ...
                className="ml-3 relative inline-flex disabled:line-through focus:outline-none focus:ring focus:ring-indigo-600 disabled:bg-gray-300 font-semibold items-center px-4 py-2 border border-gray-300 text-sm rounded-md text-gray-700 bg-white hover:bg-gray-100"
              >
